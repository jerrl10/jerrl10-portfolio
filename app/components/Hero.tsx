...
export default function Hero() {
  return (
    <section
      id="home"
      className="relative w-full min-h-[0vh] py-16 flex items-center justify-center"
    >
      {/* Centered row with max width */}
      <div className="flex flex-col md:flex-row items-center justify-center max-w-5xl w-full mx-auto gap-x-10 px-6">
        {/* LEFT: Text */}
